#[doc = "Reader of register PDCM_PD_SRAM0_SENSE"]
pub type R = crate::R<u32, super::PDCM_PD_SRAM0_SENSE>;
#[doc = "Writer for register PDCM_PD_SRAM0_SENSE"]
pub type W = crate::W<u32, super::PDCM_PD_SRAM0_SENSE>;
#[doc = "Register PDCM_PD_SRAM0_SENSE `reset()`'s with value 0"]
impl crate::ResetValue for super::PDCM_PD_SRAM0_SENSE {
    type Type = u32;
    #[inline(always)]
...
impl From<S_PD_SRAM0_ON_A> for bool {
    ...
    fn from(variant: S_PD_SRAM0_ON_A) -> Self {
        match variant {
            S_PD_SRAM0_ON_A::ENABLE => true,
            S_PD_SRAM0_ON_A::DISABLE => false,
        }
    }
}
...
impl S_PD_SRAM0_ON_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> S_PD_SRAM0_ON_A {
        match self.bits {
            true => S_PD_SRAM0_ON_A::ENABLE,
            false => S_PD_SRAM0_ON_A::DISABLE,
        }
    }
    #[doc = "Checks if the value of the field is `ENABLE`"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == S_PD_SRAM0_ON_A::ENABLE
    }
    #[doc = "Checks if the value of the field is `DISABLE`"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == S_PD_SRAM0_ON_A::DISABLE
    }
}
#[doc = "Write proxy for field `S_PD_SRAM0_ON`"]
pub struct S_PD_SRAM0_ON_W<'a> {
    w: &'a mut W,
}
impl<'a> S_PD_SRAM0_ON_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: S_PD_SRAM0_ON_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn enable(self) -> &'a mut W {
        self.variant(S_PD_SRAM0_ON_A::ENABLE)
    }
    #[doc = "Disable sensitivity to PD_SRAM0"]
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
        self.variant(S_PD_SRAM0_ON_A::DISABLE)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl W {
    ...
    #[doc = "Bit 3 - Enable sensitivity to PD_SRAM0"]
    #[inline(always)]
    pub fn s_pd_sram0_on(&mut self) -> S_PD_SRAM0_ON_W {
        S_PD_SRAM0_ON_W { w: self }
    }
    #[doc = "Bit 16 - Enable PDEXPIN\\[0\\] signal Sensitivity"]
    #[inline(always)]
